...
public class TransactionFirebase extends ArrayAdapter<TransactionAdapter> {
    private FragmentActivity context;
    private int resource;
    private List <TransactionAdapter> list;

    public TransactionFirebase(@NonNull FragmentActivity context, @LayoutRes int resource, @NonNull List<TransactionAdapter> objects) {
    ...
    @Override
    public TransactionAdapter getItem(int position) {
